...
public class Util {
	...
	public static final int AIRLINE_ID_INDEX = 1;
	public static final int FLIGHT_NUM_INDEX = 2;
	public static final int ORIGIN_INDEX = 3;
	public static final int DEST_INDEX = 4;
	public static final int CRC_DEPART_TIME_INDEX = 5;
	public static final int DEP_DELAY_15_INDEX = 6;
	public static final int CRC_ARRIVE_TIME_INDEX = 7;
	public static final int ARR_DELAY_15_INDEX = 8;

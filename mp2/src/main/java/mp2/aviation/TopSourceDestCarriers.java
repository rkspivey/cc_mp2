...
public class TopSourceDestCarriers extends Configured implements Tool {
    public static final Log LOG = LogFactory.getLog(TopSourceDestCarriers.class);
    
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new TopSourceDestCarriers(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        Job jobA = Job.getInstance(conf, "SourceDest Carriers");
